<div
	id="about-me"
	class="about-me hero min-h-screen bg-base-100 dark:bg-neutral dark:text-neutral-content"
>
	<div class="hero-content max-w-4xl w-full flex justify-start">
		<div class="max-w-4xl">
			...
			<p class="mt-4 text-base max-w-xl md:text-lg tracking-wide">
				...
				features. As a self-taught programmer, I am constantly seeking out new learning
				opportunities and challenges to improve my skills and expand my knowledge in the field of
			...
			<div class="social mt-2">
				<a
					...
					target="_blank"
					rel="noreferrer"
					class="badge badge-accent badge-lg dark:badge-secondary"
					href="https://github.com/mystique09">Github</a
				>
				<a
					id="linkedin-aboutme"
					aria-label="linkedin-aboutme"
					target="_blank"
					rel="noreferrer"
					class="badge badge-accent badge-lg dark:badge-secondary"
